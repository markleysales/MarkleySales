...
<div float="left">
   <img width="100%" src="https://metrics.lecoq.io/markleysales?template=classic&base.header=0&base.activity=0&base.community=0&base.repositories=0&base.metadata=0&activity=1&isocalendar=1&isocalendar.duration=half-year&activity.limit=5&activity.load=300&activity.days=14&activity.visibility=all&activity.timestamps=false&activity.filter=all&config.timezone=America%2FSao_Paulo">
</div>
<!-- --README MADE BY MARKLEY SALES!--README MADE BY MARKLEY SALES!-- -->
